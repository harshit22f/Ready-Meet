...
mongoose
    .connect("mongodb+srv://hrshtgupta006:<Harshit@1234>@readymeet.kqylsio.mongodb.net/?retryWrites=true&w=majority", {
...
app.use(cookie({ maxAge: 30 * 24 * 60 * 60 * 1000, keys: ["hrshtgupta006"] }));
